...
public class IllnessHistoryDTOsTest {
    ...
    @Test
    void testToString() {
        String expectedToString = "IllnessHistoryDTOs(illnessList=[Illness1, Illness2])";
        assertEquals(expectedToString, illnessHistoryDTOs1.toString());
    }

    @Test
    void testCanEqual() {
        assertTrue(illnessHistoryDTOs1.canEqual(illnessHistoryDTOs2));
    }
}
