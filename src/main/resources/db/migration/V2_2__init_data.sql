...
VALUES ('Walter', 'White','w.white@gmail.com','80332456791','+48 212 267 217',  currval('address_address_id_seq') - 2, 4);

INSERT INTO patient (name, surname,email, pesel, phone, address_id, user_id)
VALUES ('Skyler', 'White','s.white@gmail.com', '90234381912','+48 318 126 891', currval('address_address_id_seq') - 1, 5);
